...
from repository.mongo_repository import MongoTeamRepository
...
async def get_team_service(
    ...
    """Get Team Service instance with dependencies"""
    settings = get_settings()

    repository = MongoTeamRepository(mongo_db)

    service = TeamService(
        repository=repository,
        redis_client=redis,
        kafka_producer=kafka,
        cache_ttl=settings.cache_ttl_team
    )
