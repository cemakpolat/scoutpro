...
class TeamAPI:
    ...
    def lookup_f40_root(self):
        query_object = feedAPI.QueryPipeline.QueryPipeline(F40_Root)
    ...
    def lookup_f1_root_match_data(self):
        query_object = feedAPI.QueryPipeline.QueryPipeline(F1_Root)
    ...
    def get_general_team_stats(
        ...
        if doc_name is not None:
            ...
            main_query_object = feedAPI.QueryPipeline.QueryPipeline(main_document_object)
    ...
    def get_filtered_stats_teams(
        ...
        query_object = feedAPI.QueryPipeline.QueryPipeline(root_document=root_document)
